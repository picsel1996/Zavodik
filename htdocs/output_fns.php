...
function do_html_heading($heading)
{
  // print heading
?>
  <h2><img src='img/load.gif' width='27' alt='' /><?=$heading?></h2>
<?
}
...
function display_login_form()
{
  ...
  //<a href="register_form.php">Не зарегистрированы?</a> - регистрация только админом на signup.php
?>
  <form method=post action="zavod.php"> <? //member.php ?>
  <table>
   <tr>
     <td colspan=2>Авторизация:</td>
   <tr>
     <td>Login:</td>
     <td><input type=text name=username placeholder="Логин" required></td></tr>
   <tr>
     <td>Password:</td>
     <td><input type=password name=passwd placeholder="Пароль" required></td></tr>
   <tr><input type=submit value="Вход"></tr>
 </table></form>
<?
}
